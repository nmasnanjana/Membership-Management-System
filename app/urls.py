...
urlpatterns = [
    ...
    path('member/id-card/<str:member_id>/', member_id_card_view, name='member_id_card_view'),
    path('member/id-card/<str:member_id>/image/<str:side>.png', member_id_card_image, name='member_id_card_image'),
